var GameState3={
  ...
  preload: function() {
    ...
    this.load.json('level3','assets/data/level3.json')
  },
  create: function() {
    ...
    this.level3Data = this.game.cache.getJSON('level3');
    var platformData = this.level3Data.platformData;
    var targetData = this.level3Data.targetData;
    var target2Data = this.level3Data.target2Data;
    ...
    var fireData = this.level3Data.fireData;
