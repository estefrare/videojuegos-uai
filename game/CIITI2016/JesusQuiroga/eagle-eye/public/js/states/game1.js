var GameState1 = {
  ...
  preload: function() {
    ...
    this.load.json('level1','assets/data/level1.json')
  },
  create: function() {
    ...
    this.level1Data = this.game.cache.getJSON('level1');
    var platformData = this.level1Data.platformData;
    var targetData = this.level1Data.targetData;
    var target2Data = this.level1Data.target2Data;
    ...
    /*var fireData = this.level1Data.fireData;
